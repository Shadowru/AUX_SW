...
TEST(common_interop, RAW_IMU)
{
    ...
    mavlink_raw_imu_t packet_c {
         93372036854775807ULL, 17651, 17755, 17859, 17963, 18067, 18171, 18275, 18379, 18483, 211
    };
...
TEST(common, OPEN_DRONE_ID_AUTHENTICATION)
{
    ...
    packet_in.authentication_type = 5;
    packet_in.data_page = 72;
    packet_in.authentication_data = {{ 139, 140, 141, 142, 143, 144, 145, 146, 147, 148, 149, 150, 151, 152, 153, 154, 155, 156, 157, 158, 159, 160, 161 }};
...
TEST(common_interop, OPEN_DRONE_ID_AUTHENTICATION)
{
    ...
    mavlink_open_drone_id_authentication_t packet_c {
         5, 72, { 139, 140, 141, 142, 143, 144, 145, 146, 147, 148, 149, 150, 151, 152, 153, 154, 155, 156, 157, 158, 159, 160, 161 }
    };
...
TEST(common, OPEN_DRONE_ID_SELFID)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::OPEN_DRONE_ID_SELFID packet_in{};
    packet_in.description_type = 5;
    packet_in.description = to_char_array("BCDEFGHIJKLMNOPQRSTUVW");

    mavlink::common::msg::OPEN_DRONE_ID_SELFID packet1{};
    mavlink::common::msg::OPEN_DRONE_ID_SELFID packet2{};
...
#ifdef TEST_INTEROP
TEST(common_interop, OPEN_DRONE_ID_SELFID)
{
    mavlink_message_t msg;
    ...
    mavlink_open_drone_id_selfid_t packet_c {
    ...
    mavlink_msg_open_drone_id_selfid_encode(1, 1, &msg, &packet_c);
...
TEST(common, OPEN_DRONE_ID_SYSTEM)
{
    ...
    packet_in.flags = 65;
    packet_in.remote_pilot_latitude = 963497464;
    packet_in.remote_pilot_longitude = 963497672;
    packet_in.group_count = 18067;
    packet_in.group_radius = 18171;
    packet_in.group_ceiling = 73.0;
    packet_in.group_floor = 101.0;
    ...
    EXPECT_EQ(packet1.flags, packet2.flags);
    EXPECT_EQ(packet1.remote_pilot_latitude, packet2.remote_pilot_latitude);
    EXPECT_EQ(packet1.remote_pilot_longitude, packet2.remote_pilot_longitude);
    EXPECT_EQ(packet1.group_count, packet2.group_count);
    EXPECT_EQ(packet1.group_radius, packet2.group_radius);
    EXPECT_EQ(packet1.group_ceiling, packet2.group_ceiling);
    EXPECT_EQ(packet1.group_floor, packet2.group_floor);
}
...
TEST(common_interop, OPEN_DRONE_ID_SYSTEM)
{
    ...
    EXPECT_EQ(packet_in.flags, packet2.flags);
    EXPECT_EQ(packet_in.remote_pilot_latitude, packet2.remote_pilot_latitude);
    EXPECT_EQ(packet_in.remote_pilot_longitude, packet2.remote_pilot_longitude);
    EXPECT_EQ(packet_in.group_count, packet2.group_count);
    EXPECT_EQ(packet_in.group_radius, packet2.group_radius);
    EXPECT_EQ(packet_in.group_ceiling, packet2.group_ceiling);
    EXPECT_EQ(packet_in.group_floor, packet2.group_floor);
