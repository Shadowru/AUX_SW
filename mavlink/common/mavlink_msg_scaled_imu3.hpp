// MESSAGE SCALED_IMU3 support class
...
/**
 * @brief SCALED_IMU3 message
 *
 * The RAW IMU readings for 3rd 9DOF sensor setup. This message should contain the scaled values to the described units
 */
struct SCALED_IMU3 : mavlink::Message {
    static constexpr msgid_t MSG_ID = 129;
    static constexpr size_t LENGTH = 22;
    static constexpr size_t MIN_LENGTH = 22;
    static constexpr uint8_t CRC_EXTRA = 46;
    static constexpr auto NAME = "SCALED_IMU3";
